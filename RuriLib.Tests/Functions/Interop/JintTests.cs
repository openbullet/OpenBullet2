...
public class JintTests
{
    ...
    public void InvokeJint_IntegerSum_ReturnInteger()
    {
        ...
        Assert.Equal(8, engine.GetValue("result").AsNumber().ToInt());
    }
    ...
    public void InvokeJint_FloatSum_ReturnFloat()
    {
        ...
        engine.Execute("var result = x + y;");
        Assert.Equal(8.7f, engine.GetValue("result").AsNumber().ToSingle());
    }
    ...
    public void InvokeJint_StringChain_ReturnString()
    {
        ...
        engine.Execute("var result = x + y;");
        Assert.Equal("mystring", engine.GetValue("result").AsString());
    }
    ...
    public void InvokeJint_OutputList_ReturnList()
    {
        ...
        engine.SetValue("y", "b");
        engine.Execute("var result = [ x, y ];");
        var outputList = engine.GetValue("result").AsArray().GetEnumerator().ToEnumerable().ToList();
    ...
    public void InvokeJint_InputList_ReturnString()
    {
        ...
        Assert.Equal("a", engine.GetValue("result").AsString());
    }
    ...
    public void InvokeJint_NoOutputs_ReturnNothing()
    {
        ...
        Assert.True(engine.GetValue("result").IsUndefined());
    }
}

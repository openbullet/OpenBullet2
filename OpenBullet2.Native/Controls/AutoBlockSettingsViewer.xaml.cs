...
public class AutoBlockSettingsViewerViewModel(BlockViewModel block) : BlockSettingsViewerViewModel(block)
{
    public AutoBlockInstance AutoBlock => (AutoBlockInstance)Block;
...
public class BlockSettingsViewerViewModel(BlockViewModel block) : ViewModelBase
{
    public BlockViewModel BlockVM { get; init; } = block;
    public BlockInstance Block => BlockVM.Block;

    public string NameAndId => $"{BlockVM.Block.ReadableName ?? string.Empty} ({BlockVM.Block.Id})";

...
public partial class IntSettingViewer : UserControl
{
    ...
    private IntSettingViewerViewModel ViewModel => vm
...
public class IntSettingViewerViewModel(BlockSetting setting) : ViewModelBase
{
    ...
    private IntSetting FixedSetting => (IntSetting)Setting.FixedSetting!;
}

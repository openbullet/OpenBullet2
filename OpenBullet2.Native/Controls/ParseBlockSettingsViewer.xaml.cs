...
public class ParseBlockSettingsViewerViewModel(BlockViewModel block) : BlockSettingsViewerViewModel(block)
{
    public ParseBlockInstance ParseBlock => (ParseBlockInstance)Block;

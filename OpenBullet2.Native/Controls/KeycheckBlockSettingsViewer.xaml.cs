...
public class KeycheckBlockSettingsViewerViewModel(BlockViewModel block) : BlockSettingsViewerViewModel(block)
{
    public KeycheckBlockInstance KeycheckBlock => (KeycheckBlockInstance)Block;

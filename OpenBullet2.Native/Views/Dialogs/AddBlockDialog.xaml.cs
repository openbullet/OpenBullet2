...
public partial class AddBlockDialog : Page
{
    ...
    {
        if (sender is Button { Tag: CategoryTreeNode category })
        {
    ...
    {
        if (sender is not FrameworkElement { Tag: BlockDescriptor descriptor })
        {
            return;
        }
...
public class AddBlockDialogViewModel : ViewModelBase
{
    ...
    private CategoryTreeNode currentNode = null!;

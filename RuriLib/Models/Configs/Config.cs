...
public class Config
{
    ...
    /// The blocks stack.
    /// </summary>
    public List<BlockInstance> Stack { get; set; } = [];
    ...
    private string stackerHash = string.Empty;
    private string loliCodeHash = string.Empty;
    private string loliScriptHash = string.Empty;
    ...
    public void ChangeMode(ConfigMode newMode)
    {
        ...
        if (mappings.TryGetValue((Mode, newMode), out var mapping))
        {
            mapping.Invoke();
            Mode = newMode;
        }

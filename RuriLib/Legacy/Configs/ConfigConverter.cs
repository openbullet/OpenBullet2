...
{
    /// <summary>
    /// Converts a serialized legacy config into the current config model.
    /// </summary>
    /// <param name="fileContent">The full legacy config contents.</param>
    /// <param name="id">The identifier to assign to the converted config.</param>
    /// <returns>The converted config instance.</returns>
